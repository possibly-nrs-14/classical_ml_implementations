# Machine‑Learning Algorithms Sandbox
...
| `decision_tree.ipynb`     | Decision‑Tree Classifier                     | entropy vs Gini, categorical encoding, fraud‑detection model   |
| `linear_regression.ipynb` | Linear Regression                            | food delivery time prediction, feature scaling, residual diagnostics     |
